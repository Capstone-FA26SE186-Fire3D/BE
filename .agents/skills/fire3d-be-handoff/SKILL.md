---
name: fire3d-be-handoff
description: Resume or checkpoint a Fire3D BE task using repo-local handoff and lessons. Use for continuing, pausing, or handing off work in BE, not for other repos or automatic releases.
---

# Bàn giao BE

1. Xác định gốc repo chứa skill này (đi lên từ .agents/skills/fire3d-be-handoff); đọc AGENTS.md và .codex/context.md, .codex/workflow.md tại gốc đó. Không dựa vào cwd đang ở workspace cha hoặc repo khác.
